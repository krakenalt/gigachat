...
from gigachat.schemas.legacy_chat import LegacyMessage, LegacyMessageRole
from gigachat.schemas.threads import (
    ThreadCompletion,
...
from gigachat.transport import threads
...
def _parse_message(message: Union[LegacyMessage, str, Dict[str, Any]]) -> LegacyMessage:
    if isinstance(message, str):
        return LegacyMessage(role=LegacyMessageRole.USER, content=message)
    else:
        return LegacyMessage.model_validate(message)
...
class ThreadsSyncClient:
    ...
    @_with_retry
    @_with_auth
    def retrieve(self, threads_ids: List[str]) -> ThreadList:
    ...
    @_with_retry
    @_with_auth
    def add_message(self, thread_id: str, message: Union[LegacyMessage, str, Dict[str, Any]]) -> ThreadMessagesResponse:
    ...
    def add_messages(
        ...
        messages: Optional[List[Union[LegacyMessage, str, Dict[str, Any]]]] = None,
    ) -> ThreadMessagesResponse:
    ...
    def run_messages(
        self,
        messages: List[Union[LegacyMessage, str, Dict[str, Any]]],
        thread_id: Optional[str] = None,
        assistant_id: Optional[str] = None,
...
class ThreadsAsyncClient:
    ...
    @_awith_retry
    @_awith_auth
    async def retrieve(self, threads_ids: List[str]) -> ThreadList:
        """Return a list of threads by their IDs."""
    ...
    async def add_message(
        self, thread_id: str, message: Union[LegacyMessage, str, Dict[str, Any]]
    ) -> ThreadMessagesResponse:
        """Add a message to a thread."""
        message_ = _parse_message(message)
