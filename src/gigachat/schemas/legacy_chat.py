...
from gigachat.schemas.response_format import ResponseFormat
...
LegacyMessageRole = MessagesRole
LegacyMessage = Messages
LegacyChatRequest = Chat
CompletionChoice = Choices
CompletionChoiceChunk = ChoicesChunk
LegacyChatResponse = ChatCompletion
LegacyChatStreamChunk = ChatCompletionChunk
