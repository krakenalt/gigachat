...
from gigachat.schemas._schema_normalize import to_strict_json_schema
from gigachat.schemas.base import APIResponse
from gigachat.schemas.legacy_chat import Function, FunctionCall
...
StructuredContentPart = ChatV2ContentPart
StructuredMessage = ChatV2Message
StructuredChatRequest = ChatV2
StructuredTool = ChatV2Tool
StructuredChatResponse = ChatCompletionV2
StructuredChatStreamChunk = ChatCompletionV2Chunk
