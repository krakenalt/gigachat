...
from gigachat.schemas.batches import Batch, BatchList
...
def _build_batches_response(response: httpx.Response) -> BatchList:
    ...
    return BatchList(x_headers=build_x_headers(response), **payload)
