...
from gigachat.schemas.legacy_chat import LegacyChatRequest, LegacyChatResponse, LegacyChatStreamChunk
...
def chat_sync(
    ...
    *,
    ...
    return execute_request_sync(client, kwargs, LegacyChatResponse)
...
async def chat_async(
    ...
    *,
    ...
    """Return a model response based on the provided messages."""
    kwargs = _get_chat_kwargs(chat=chat, access_token=access_token)
    return await execute_request_async(client, kwargs, LegacyChatResponse)
...
def stream_sync(
    ...
    *,
    chat: LegacyChatRequest,
    access_token: Optional[str] = None,
) -> Iterator[LegacyChatStreamChunk]:
    ...
    return execute_stream_sync(client, kwargs, LegacyChatStreamChunk)
...
def stream_async(
    ...
    *,
    chat: LegacyChatRequest,
    access_token: Optional[str] = None,
) -> AsyncIterator[LegacyChatStreamChunk]:
    """Return a model response based on the provided messages (streaming)."""
    kwargs = _get_stream_kwargs(chat=chat, access_token=access_token)
    return execute_stream_async(client, kwargs, LegacyChatStreamChunk)
