...
from gigachat.schemas.legacy_chat import LegacyMessage
...
def get_threads_sync(
    ...
    *,
    ...
    return execute_request_sync(client, kwargs, ThreadList)
...
async def get_threads_async(
    ...
    *,
    ...
    return await execute_request_async(client, kwargs, ThreadList)
